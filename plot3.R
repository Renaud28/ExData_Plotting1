...
plot(twodays$Date_hour, twodays$Sub_metering_1, main ="", xlab="", ylab="Energy sub metering",type="l" )
lines(twodays$Date_hour, twodays$Sub_metering_2, col="red")
lines(twodays$Date_hour, twodays$Sub_metering_3, col="blue")
